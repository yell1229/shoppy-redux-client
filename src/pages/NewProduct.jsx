...
export default function NewProduct() {
    ...
    const getFileName = (fileNames) => {
        ...
        // setPreview(`http://43.200.191.105:9000/${fileNames.uploadFileName}`);   
    ...
    const handleSubmit = (e) => {
        ...
        if(productNameRef.current.value === '') {
            ...
            axios   
                .post('http://43.200.191.105:9000/product/new', formData)
                .then(res => {
                    ...
                    <li>
                        ...
                        {/** 다중파일 preview */}
                        {
                            previewList && previewList.map((preview)=>
                                <img src={`http://43.200.191.105:9000/${preview}`}  
                                    alt="preview image"
